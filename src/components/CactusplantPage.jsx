...
<div className='product'>
  ...
  <div className='filterlist'>
    <ul>
      <h5>Category</h5>
      <li><Link to="/products" style={{ color: '#000000', textDecoration:'none'}}>Plant</Link></li>
  ...
  <div className="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <button className="dropdown-item" type="button">Cactus seller</button>
  </div>
</div>
  </div>
...
export default CactusplantPage