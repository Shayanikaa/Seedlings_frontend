...
function Products() {
  ...
  const handleView = () => {
    alert("Functionality not working!")
  }
          ...
          <div className='searchb'>
            <nav className="filter-navbar">
              <form className="searchform">
                ...
                <button className="mybutton btn-outline-success my-2 my-sm-0" type="submit"  >Search</button>
              </form>
        ...
        <div className='product-header'>
          ...
          <div className='main-products'>
            {view === false ? (
              <>
                <div className='row'>
                  {user && user.length > 0 && user.filter((item) => {
                    return search.toLowerCase() === '' ? user : item.name.toLowerCase().includes(search);
                  }).map((userObj, index) => {
                    return (
                      <div key={index} className='col-md-4 mb-4'>
                        <div className="mycard" style={{ width: '20rem' }}>
